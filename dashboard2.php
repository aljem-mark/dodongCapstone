...
$colr = ["#c0392b","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99","#cd6155","#d98880","#e74c3c","#ec7063","#f1948a","#2c3e50","#566573","#808b96","#34495e","#5d6d7e","#85929e","#d35400","#dc7633","#edbb99","#f1c40f","#dc7633","#e59866","#edbb99"];
                 $today = date("Y-m-d");
...
<div>
<div>
 <p class="bg-danger" class=><?php echo $_SESSION['iError'];?></p>
</div>
...
<!-- <!-		<div class="col-md-6" style="margin-top: 50px;">  -->
 ...
 $ixxx = 0;
                                            ...
                                            for($x=1;$x < $datediffx+2 ; $x++){
                                                ...
                                                $DateS =  $DateS[2].'-'.$DateS[0].'-'.$DateS[1];
                                                   ...
                                                   $select2 = mysqli_query($con,"SELECT 
																		...
																		WHERE  status <> 'pending'  and a.dateApnted = '".$DateS."' and a.timeApnted LIKE '%".($y + 7). ':00'."%' ;"); 
                                                        ...
                                                        //
                                                            ...
                                                            if ($cc == 0 ){ 
                                                               ...
                                                               if  ( $ix == $iDay1st)   {
                                                                ...
                                                                ?>
																 <td style="height:1px!important;background-color:<?php echo $colr[$x]; ?>;  height:100%;" > <button style="background-color:<?php echo $colr[$x]; ?>; border:solid 0px black; width:100%;height:100%;"  type="button"  data-toggle="modal" data-target="<?php echo "#iMoadlOption".$y.$x;?>"><?php echo $row2['fullname'].'<br><i class="fas fa-cog"></i>';?></button></td>
																 <?php
															...
															<div class="row" >
																...
																<div class="col-sm-6" >
																	...
																	echo $xcc[0] ;
																		...
																		echo $xcc[0] .' To '. $x[count($x)-1];
																		}
																		?> </p>
																		<p> <?php echo $row2['service_name'];?> </p>
																		<p> <?php echo $row2['iPrice'];?> </p>
																		<p> <input name="adjust"   /> </p>
																		<p> <input name="adjustRemarks"   /> </p>
																	 </b>
																</div>
		...
		<div class="col-sm-4" ><br> <center><input type="submit"  name="<?php echo "modelDELETE".$y.$x; ?>"   style="border:0; width:50px;height:25px; background-color:#d44a26;color:#f7f7f7;" value='Delete'/>   </div>
		...
		<div class="col-sm-4" ><br> <center><input type="submit"  name="<?php echo "modalSAVE".$y.$x; ?>" style="border:0; width:50px;height:25px; background-color:#377796;color:#f7f7f7;" value='Save'/>   </div>
